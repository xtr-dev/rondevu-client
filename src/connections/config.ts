 ...
 * @internal
 */
export function mergeConnectionConfig(userConfig?: Partial<ConnectionConfig>): ConnectionConfig {
    return {
 ...
 */
export function toConnectionConfig(options?: ConnectionOptions): ConnectionConfig {
    if (!options) return DEFAULT_CONNECTION_CONFIG
